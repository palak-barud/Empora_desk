						...
						<div class="card-body" style="padding-top: 15px;">
							...
							<form action="Employeeservlet" method="post" id="frmMr">
								<div class="row g-3 needs-validation" novalidate>
									...
									<div class="col-lg-4 refresh-container" data-add="add_dept.jsp"
										...
										<div class="control form-floating  refresh-input">
											...
											<input type="hidden" id="dept_id_fk" name="dept_id_fk"
												value="<%=dto.getDept_id_fk()%>" /> <label
												for="dl_no">Department Name</label>
									...
									<div class="col-md-3 d-flex align-items-center">
										...
										<div class="form-check me-2">
											<input class="form-check-input" type="radio" name="Radio"
												id="radio" value="Male" required <%if (dto.getGender().equalsIgnoreCase("Male")) {%>
														checked <%}%>> <label
												class="form-check-label" for="male">Male</label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="radio" name="Radio"
												id="radio" value="Female" required <%if (dto.getGender().equalsIgnoreCase("Female")) {%>
														checked <%}%>> <label
									...
									<div class="col-lg-3 balesElement">
										<div class="control form-floating">
											<input type="date" class="form-control" id="leave"
												name="Leave" placeholder="Bargain Bales" value=""> <label
												for="bargain_bales">Leaving Date </label>
									...
									<div class="col-lg-3 balesElement">
										<div class="control form-floating">
											<input required type="number" class="form-control"
												...
												value="<%=dto.getSalary()%>"> <label for="length">Salary</label>
