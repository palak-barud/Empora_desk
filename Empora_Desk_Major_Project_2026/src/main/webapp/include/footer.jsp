...
<footer id="footer" class="row footer">
	<div class="copyright col-lg-8 col-sm-12 ">
		&copy; Copyright: <span><a href="https://mykhandwa.com/">
				</a></span> All Rights Reserved.
	</div>
	<div class="copyright-1 col-lg-4 col-sm-12 ">
		Developed By : <a href="#">Shivi Prajapati & Palak Barud</a>
	</div>
</footer>
<!-- End Footer -->
...
String[][] alertHrefs = {{"user.jsp"}, {"bank.jsp"}, {"vehicle.jsp"}, {"city.jsp"}, {"company.jsp"}, {"billty.jsp"},
		{"customer.jsp"}, {"dealer.jsp"}, {"purchase_other_bill.jsp"}, {"dealer_other.jsp"},
		{"dealer_other_due.jsp", "pay_dealer_other_due.jsp"}, {"dealer_other_due.jsp"}};

// alert ke liye 
String[] alertTitles = {"User", "Bank", "Vehicle", "Destination", "Company", "Billty", "Billing Party", "Vehicle Party",
		"Vehicle Spend", "Vehicle Dealer", request.getParameter("alert_title"), "Vehicle Dealer Due"};
