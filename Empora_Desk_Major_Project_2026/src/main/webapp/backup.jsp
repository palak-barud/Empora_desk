...
String database = db.getDb_name();
String filename = database + "_backup_" + current_date + ".sql";
// String filepath = "C:/wamp/bin/mysql/mysql5.1.36/bin/";
// String filepath = "C:/xampp/mysql/bin/"; 
 String filepath = ""; 

 if (db.getServer_type().equalsIgnoreCase("xampp")){ // for xampp server
	 filepath = "D:/Software/xampp/mysql/bin/"; 
 }
 
 if (db.getServer_type().equalsIgnoreCase("wamp")){ // for wamp server
	 filepath = "C:/wamp/bin/mysql/mysql5.1.36/bin/";
 }

String url = "jdbc:mysql://localhost:3306/" + database;
String username = db.getUser_name();
